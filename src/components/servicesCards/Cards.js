    ...
    <>
      <div id="cards">
        <div className="main-cards-header container">
          <h1>WELCOME TO CAMERON PARK REHAB</h1>
        ...
        <div className="cards-header ">
          <div class="card-wrap">
            <div className="cards-header-left">
              <h3>
                Cameron Park Rehab makes getting treatment{" "}
                <span>possible.</span>
              </h3>
              <br />
              <p>
                At Cameron Park Rehab Treatment Center, clients receive
            ...
            <div class="tile">
              ...
              <div class="text">
                ...
                <p class="animate-text">
                  ...
                  you are dealing with, there’s something for everyone at
                  Cameron Park Rehab.
                </p>
                <div class="animate-text">
                  <LinkRoll
