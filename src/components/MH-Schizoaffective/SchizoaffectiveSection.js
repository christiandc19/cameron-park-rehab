...
<div className="Schizoaffective-section-header container">
                ...
                <ul>
                  <li><AiFillCheckCircle className='star'/> Bipolar (episodes of mania and occasional depression)</li>
                  <li><AiFillCheckCircle className='star'/> Depressive (depression episodes)</li><br/>
                </ul>
