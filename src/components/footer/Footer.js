        ...
        <div className='footer'>
            <div className="container">
                <div className="top">
                    ...
                    <img src={logo} width="100px" height="60px" alt="Cameron Park Rehab Logo" loading="lazy"/>
                    </div>
                ...
                <p className='copyright'><p>&copy; 2023 CAMERON PARK REHAB TREATMENT CENTER. ALL RIGHTS RESERVED.</p></p>
