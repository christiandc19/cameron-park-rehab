            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div>
                ...
                <div className="textarea2 feedback hidden">
                    <textarea name="message2" cols="30" rows="3" required>Message Sent to Cameron Park Rehab!</textarea>
                </div>
...
<div className="contact-cards-container">
    ...
    <div class="get_form_inner2">
            <h2>CALL US</h2>
            <p><AiOutlinePhone /><a href="tel:3234029939"> +1 (323) 402-9939</a></p>
    </div>

    <div class="get_form_inner2">
            <h2>EMAIL</h2>
            <p><AiOutlineMail /> info@cameronparkrehab.com  </p><br />
    </div>

    <div class="get_form_inner2">
            <h2>LOCATION</h2>
            <p><BsFillPinMapFill /> 4120 Cameron Park Dr. Suite 403, Cameron Park, CA 95682 </p>
    </div>
